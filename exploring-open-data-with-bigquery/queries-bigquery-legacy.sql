...
--
-- These are in BigQuery's legacy SQL syntax - https://cloud.google.com/bigquery/docs/reference/standard-sql/migrating-from-legacy-sql
...
-- Discover the most popular 100 films
select title, id, count(id) as edits 
from [publicdata:samples.wikipedia]
where 
  wp_namespace = 0
